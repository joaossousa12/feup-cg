...
export class MyFlower extends CGFobject {
    constructor(scene, steamRadius, laefPetalSize){
        super(scene);
        this.petalNumber = this.getRandomValue(4, 8, 'int');;
        ...
        this.laefPetalSize = laefPetalSize;
        ...
        this.laefSteamHigh = steamRadius+0.3;
        this.laefSteam = new MyStem(this.scene, 16, 16, 0.05, this.laefSteamHigh);
        this.laefPetal = new MyPetal(this.scene, this.laefPetalSize);
        this.initMaterials();
    }
    ...
    display(){
        ...
        for(var i = 1; i < (this.steamHigh); i++){
            if((i%2) === 0){
                ...
                this.scene.rotate(Math.PI/2, 1, 0, 0);
                this.scene.translate(i,this.laefSteamHigh-0.05,0);
                this.petalLightGreenMaterial.apply();
                this.laefPetal.display();
                this.scene.popMatrix();
            } else{
                this.scene.pushMatrix();
                this.scene.rotate(Math.PI / 2, 0, 0, 1);
